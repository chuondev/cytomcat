 ...
 */
package com.chuonye.tomcat.startup;
...
public class Bootstrap {
    static {
        ...
        // Home first
        String home = System.getProperty("cytomcat.base");
        File homeFile = null;
        ...
        System.setProperty("cytomcat.base", homeFile.getPath());
    }
    ...
    private void init() throws Exception {
        ...
        Class<?> clazz = commonLoader.loadClass("com.chuonye.tomcat.container.core.Context");
    ...
    /**
     * 创建一个 URLClassLoader，默认加载路径是 cytomcat.base/lib 以及 cytomcat.base/lib/*.jar
     * 
     * @param parent
     *            父类加载器
    ...
    private ClassLoader createClassLoader(ClassLoader parent) throws Exception {
        ...
        File libDir = new File(System.getProperty("cytomcat.base"), "lib");
        if (libDir.exists()) {
        ...
        File log = new File(System.getProperty("cytomcat.base"), "logback.xml");
