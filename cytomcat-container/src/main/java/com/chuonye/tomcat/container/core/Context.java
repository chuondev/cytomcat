...
import com.chuonye.tomcat.container.Container;
import com.chuonye.tomcat.container.Loader;
import com.chuonye.tomcat.container.servletx.AppContext;
import com.chuonye.tomcat.container.servletx.FilterWrapper;
import com.chuonye.tomcat.container.session.Manager;
/**
...
public class Context extends Container {
    ...
    public String getDocBasePath() {
        if (docBasePath == null) {
            Path base = Paths.get(System.getProperty("cytomcat.base"), appBase, docBase);
    ...
    public void init() throws Exception {
        ...
        defaultWrapper.setServletClass("com.chuonye.tomcat.container.servletx.DefaultServlet");
