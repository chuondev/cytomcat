...
import com.chuonye.tomcat.container.Lifecycle.LifecycleEvent;
import com.chuonye.tomcat.container.Lifecycle.LifecycleListener;
import com.chuonye.tomcat.util.digester.Digester;
...
public class ContextConfig implements LifecycleListener {
    ...
    private void init() {
        ...
        webXmlParser.addObjectCreate("web-app/filter", "com.chuonye.tomcat.container.servletx.FilterWrapper");
        ...
        webXmlParser.addObjectCreate("web-app/servlet","com.chuonye.tomcat.container.core.Wrapper");
        ...
        webXmlParser.addSetNext("web-app/servlet", "addChild", "com.chuonye.tomcat.container.Container");
    ...
    private void deployApp() throws Exception {
        File appBase = new File(System.getProperty("cytomcat.base"), context.getAppBase());
        File[] apps = appBase.listFiles();
        if (apps == null || apps.length == 0) {
            throw new IllegalArgumentException("必须在[" + System.getProperty("cytomcat.base") + "]部署且只能部署 一个 web 应用才能启动");
        }
